...
Start (){
    ...
    readonly PACKAGES=("putils-ping" "lm-sensors" "htop" "network-manager" "net-tools" "cockpit" "cockpit-navigator" "realmd" "tuned" "udisks2-lvm2" "samba" "winbind" "nfs-kernel-server" "nfs-common" "cockpit-file-sharing" "wireguard-tools" "unattended-upgrades")
